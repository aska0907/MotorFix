                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                if (documentSnapshot.exists()) {
                                    ...
                                    if (user != null && user.getLastName() != null) {
                                        mLastNameButton.setText(user.getLastName());
                                    }
        ...
        private void saveProfilePicture(Bitmap bitmap) {
            if (bitmap != null) {
                ...
                try {
                    ...
                    StorageReference storageRef = FirebaseStorage.getInstance().getReference().child("peoplePicture").child(fileName);
                                            ...
                                            mFirestore.collection("UserData")
                                                    ...
                                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        ...
                                                        public void onSuccess(Void aVoid) {
                                                            ...
                                                            Toast.makeText(ProfileActivity.this, "Profile picture saved successfully.", Toast.LENGTH_SHORT).show();
                                                        }
                                                    })
                                                    .addOnFailureListener(new OnFailureListener() {
                                                        @Override
    ...
    private boolean handleMenuItemClick(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_sort_region:
                startActivity(new Intent(ProfileActivity.this, ViewFeedback.class));
                // ...
                return true;
